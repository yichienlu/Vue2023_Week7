  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content border-0">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" @click="editOrder(tempOrder, adminOrderModal)">
          確認修改
        </button>
      </div>
    </div>
...
export default {
  ...
  props:['adminOrderModal'],
  methods:{
    ...mapActions(adminOrdersStore, ['addOrder', 'editOrder'])
  },
  computed:{
    ...mapState(adminOrdersStore, ['tempOrder'])
  },
}
